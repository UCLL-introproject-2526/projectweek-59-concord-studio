...
def draw_map(world_height,world_width,screen_width):
    ...
    surface = minimap_surface = pygame.Surface((MINIMAP_WIDTH, MINIMAP_HEIGHT))
    pos = minimap_pos = (screen_width - MINIMAP_WIDTH - 10, 10)  # top-right
...
#mini_map gmh
    ...
    def draw_minimap(surface, pos, scale_x,scale_y,screen,player,obstacles,police,camera):
